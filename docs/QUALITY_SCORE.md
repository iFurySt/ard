...
| Testing | B | Unit tests, Postgres integration tests, build checks, upstream ARD conformance runs, and GitHub Actions CI cover core ingestion/search/admin paths. | Add reusable scripted E2E flows for artifact onboarding with pinned real MCP/A2A/Skill fixtures. |
